...
// var local;
// var playlistsObj2;
// document.getElementById("sprec1").onclick = function() { mk('/api/playlists', function(chunk){
//       playlistsObj2 = JSON.parse(chunk);
//       //console.log('processed');
//       // var input = prompt("What's the name of new playlist?");
//       // var obj = {
...
//       // console.log('in callback ' + obj);
//
//
//   });
// };
// function mk(url, callback){
...
//         if (hr.status === 200) {
//           local = hr.responseText;
//           callback.apply(this, [local]);
//           console.log('get playlists local');
//           //var playlistsObj = JSON.parse(local)
//         } else {
...
//   console.log(playlistsObj2);
//   hr.send(playlistsObj2);
//
// }
